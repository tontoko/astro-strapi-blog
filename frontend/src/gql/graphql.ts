...
export type QueryBlogSettingsQuery = {
  __typename?: "Query";
  blogSetting?: {
    __typename?: "BlogSettingEntityResponse";
    data?: {
      __typename?: "BlogSettingEntity";
      attributes?: { __typename?: "BlogSetting"; title?: string | null } | null;
    } | null;
  } | null;
};
...
export type QueryPostBySlugQuery = {
  __typename?: "Query";
  posts?: {
    __typename?: "PostEntityResponseCollection";
    data: Array<{
...
export const QueryBlogSettingsDocument = {
  ...
  QueryBlogSettingsQuery,
  QueryBlogSettingsQueryVariables
>;
export const QueryPostBySlugDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "queryPostBySlug" },
      variableDefinitions: [
        {
  ...
  QueryPostBySlugQuery,
  QueryPostBySlugQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "queryPosts" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<QueryPostsQuery, QueryPostsQueryVariables>;
